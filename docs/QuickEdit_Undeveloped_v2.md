...
版本：v1.0
日期：2026-09-17
状态：V1 稳定版候选完成；v2.0+ 需求设计已成文（三份设计文档，均为 Draft）
依据：
...
| 5 | 完整暗色主题 | 用户已确认暂缓（V1 中点击仅提示"暂不支持"）；**未列入三份 v2.0+ 设计文档排期**，启动前需单独评估并纳入排期 |
...
| P0 | Annotation V2（Anchor + Inline Decoration） | v2.0 | 待开发 |
| P0 | PreviewCapability | v2.0 | 待开发 |
| P0 | XLSX 虚拟化 | v2.1 | 待开发 |
| P1 | HTML 静态安全预览 | v2.0 | 待开发 |
| P1 | 冲突检测 / 三方合并 | v2.0 | 待开发 |
| P1 | 批注管理（搜索/标签/状态/导出） | v2.0 | 待开发 |
| P1 | 图片 Viewer | v2.1 | 待开发 |
| P1 | 大文件 OpenMode | v2.1 | 待开发 |
| P1 | PDF 按页策略 | v2.1 | 待开发 |
| P1 | Change Review | v2.2 | 待开发 |
| P2 | PPTX Viewer | v2.2 | 待开发 |
| P2 | 工作区搜索增强 | v2.2 | 待开发 |
| P2 | MCP Bridge | v2.2 | 待开发 |
| P3 | Hunk 级审批 | v2.3+ | 待评估 |
| P3 | PDF Range Reader | v2.3+ | 待评估 |
| — | 完整暗色主题 | 未排期 | 用户确认暂缓，需立项评估 |
