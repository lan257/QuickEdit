...
## 12. 复验待办（2026-09-22 / 2026-09-24，共 12 条，已全部实现）
...
| 11 | 页面背景 | 无法为界面铺背景 | 4 款内置渐变预设 + 自选本地图片，「背景可见度」滑杆 0–100 控制表面透明度，侧栏/正文/批注面板浮在背景上并加磨砂 | 增强 | 已完成，待桌面复验 |
| 12 | 正文卡片 | 正文与窗口底色连成一片，没有质感与区分 | 正文区带描边、圆角、投影与纸面底色，可在设置里关闭 | 增强 | 已完成，待桌面复验 |
